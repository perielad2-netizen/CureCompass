...
from app.models.entities import ResearchItem, ResearchItemEmbedding, Source
...
class RetrievalService:
    ...
    def retrieve_for_condition(
        self, *, condition_id: str | uuid.UUID, query: str, limit: int = 5
    ) -> list[dict[str, Any]]:
        ...
        rows = self.db.execute(
            select(ResearchItem, Source, ResearchItemEmbedding)
